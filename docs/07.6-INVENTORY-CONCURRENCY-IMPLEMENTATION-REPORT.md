...
|---|---|---|
| [`src/models/InventoryReservation.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/models/InventoryReservation.js) | **NEW** | Sequelize model for `inventory_reservations` table with constraints and hooks. |
| [`src/models/index.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/models/index.js) | **MODIFIED** | Registered `InventoryReservation` and defined bidirectional associations with `Product`. |
| [`src/modules/inventory/inventory.constants.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/modules/inventory/inventory.constants.js) | **NEW** | Domain constants (`RESERVATION_TTL_MINUTES`, `RESERVATION_STATUS`). |
| [`src/modules/inventory/inventory.errors.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/modules/inventory/inventory.errors.js) | **NEW** | Specialized domain errors (`InsufficientStockError`, `ReservationNotFoundError`, `InventoryInvariantError`, etc.). |
| [`src/modules/inventory/inventory.dto.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/modules/inventory/inventory.dto.js) | **NEW** | DTO serializers (`toReservationDTO`, `toProductInventoryDTO`). |
| [`src/modules/inventory/inventory.validation.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/modules/inventory/inventory.validation.js) | **NEW** | Strict Zod validation schemas and middleware wrappers. |
| [`src/modules/inventory/inventory.repository.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/modules/inventory/inventory.repository.js) | **NEW** | Data access layer encapsulating row-level locking, atomic increments/decrements, and query serialization. |
| [`src/modules/inventory/inventory.service.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/modules/inventory/inventory.service.js) | **NEW** | Core transactional business operations (`reserveInventory`, `releaseReservation`, `convertReservation`, `releaseExpiredReservations`). |
| [`src/modules/inventory/inventory.controller.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/modules/inventory/inventory.controller.js) | **NEW** | Thin HTTP controllers mapping requests to service methods and sanitizing responses. |
| [`src/modules/inventory/inventory.routes.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/modules/inventory/inventory.routes.js) | **NEW** | Express router applying session auth, CSRF verification, and route parameter validation. |
| [`src/app.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/src/app.js) | **MODIFIED** | Mounted `inventoryRouter` at `/api/inventory`. |
| [`tests/inventory/helpers/inventoryTestFixtures.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/tests/inventory/helpers/inventoryTestFixtures.js) | **NEW** | Test isolation helpers provisioning valid `User`, `Order`, `Product`, and `InventoryReservation` fixtures. |
| [`tests/inventory/inventory.model.test.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/tests/inventory/inventory.model.test.js) | **NEW** | 8 unit tests for model persistence, foreign keys, TTL calculation, check constraints, DTO serializers. |
| [`tests/inventory/inventory.repository.test.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/tests/inventory/inventory.repository.test.js) | **NEW** | 10 repository tests for `SELECT FOR UPDATE`, atomic guarded decrements, rollback on invariant breach. |
| [`tests/inventory/inventory.api.test.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/tests/inventory/inventory.api.test.js) | **NEW** | 17 integration and security tests for authentication, CSRF, stock bounds, Anti-IDOR, and lifecycle. |
| [`tests/inventory/inventory.concurrency.test.js`](file:///c:/Users/ANSHUL%20SINGH%20JADON/Desktop/Ecommerce-project/ecommerce-backend/tests/inventory/inventory.concurrency.test.js) | **NEW** | 7 real PostgreSQL concurrency tests covering 10-to-1 contention, multi-quantity conflicts, lost updates, and race serialization. |
